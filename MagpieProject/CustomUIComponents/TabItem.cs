...
namespace MagpieProject.CustomUIComponents
{
    ...
    {
        public TabItem(string headerText, Xamarin.Forms.View content, ImageSource headerIcon = null)
        {
        ...
        public static readonly BindableProperty ContentProperty = BindableProperty.Create(nameof(Content), typeof(Xamarin.Forms.View), typeof(TabItem));

        public Xamarin.Forms.View Content
        {
            get => (Xamarin.Forms.View)GetValue(ContentProperty);
            set
            {
